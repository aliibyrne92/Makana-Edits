...
* */
function getRenewals(currentCustomer, querystring, locale) {
    // get all orders for this user
    var customerNo = currentCustomer.profile.customerNo;
    var customerOrders = OrderMgr.searchOrders(
        'customerNo={0} AND status!={1} AND custom.mhPrescriptionOrder=true AND custom.mhRenewable=true AND custom.mhRefillsRemaining=0',
        'creationDate desc',
        customerNo,
